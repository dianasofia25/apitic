...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull CoordinatorLayout appBarMain, @NonNull Toolbar toolbar) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      CoordinatorLayout appBarMain = (CoordinatorLayout) rootView;
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, appBarMain, toolbar);
    }
